...
emu = OriginalRecipe(training_file, method = em_method, fixed_params=fixed_params, downsample_factor = 0.1, custom_mean_function = None)
...
for idx, r in enumerate(sbc):
    ...
    emu = OriginalRecipe(training_file, method = em_method, fixed_params=fixed_params, downsample_factor = 0.5, custom_mean_function = None)
