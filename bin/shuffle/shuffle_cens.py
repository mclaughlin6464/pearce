...
for ibin in bins_in_halocat:
    ...
    shuffled_upids[indices_of_prim_haloprop_bin[satellites_idx]] = catalog[indices_of_prim_haloprop_bin[satellites_idx]]['halo_upid']
       
    shuffled_host_mvir[indices_of_prim_haloprop_bin[satellites_idx]] = catalog[indices_of_prim_haloprop_bin[satellites_idx]]['halo_mvir_host_halo']
    
    for idx, (coord) in enumerate(['x','y','z']):
        shuffled_pos[indices_of_prim_haloprop_bin[satellites_idx],idx] = catalog[indices_of_prim_haloprop_bin[satellites_idx]]['halo_'+coord]
...
catalog['halo_sh_shuffled_cen_vpeak_mag'] = shuffled_mags[:,0]
catalog['halo_sh_shuffled_cen_vvir_mag'] = shuffled_mags[:,1]
catalog['halo_sh_shuffled_cen_alpha_05_mag'] = shuffled_mags[:,2]
catalog['halo_sh_shuffled_cen_x'] = shuffled_pos[:,0]
catalog['halo_sh_shuffled_cen_y'] = shuffled_pos[:,1]
catalog['halo_sh_shuffled_cen_z'] = shuffled_pos[:,2]
catalog['halo_sh_shuffled_cen_upid']=shuffled_upids[:]
catalog['halo_sh_shuffled_cen_host_mvir'] = shuffled_host_mvir[:]
