...
for ibin in bins_in_halocat:
    ...
    for idx, coord in enumerate(['vpeak', 'vvir', 'alpha_05']):
        shuffled_mags[indices_of_prim_haloprop_bin[centrals_idx], idx]= catalog[indices_of_prim_haloprop_bin[centrals_idx]]['halo_'+coord+'_mag']
...
catalog['halo_sh_shuffled_sats_vpeak_mag'] = shuffled_mags[:,0]
catalog['halo_sh_shuffled_sats_vvir_mag'] = shuffled_mags[:,1]
catalog['halo_sh_shuffled_sats_alpha_05_mag'] = shuffled_mags[:,2]
catalog['halo_sh_shuffled_sats_x'] = shuffled_pos[:,0]
catalog['halo_sh_shuffled_sats_y'] = shuffled_pos[:,1]
catalog['halo_sh_shuffled_sats_z'] = shuffled_pos[:,2]
catalog['halo_sh_shuffled_sats_upid']=shuffled_upids[:]
catalog['halo_sh_shuffled_sats_host_mvir'] = shuffled_host_mvir[:]
