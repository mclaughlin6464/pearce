...
emulation_point = [('f_c', 0.15), ('logM0', 12.0), ('sigma_logM', 0.266), 
                    ('alpha', 0.9),('logM1', 12.7), ('logMmin', 11.733),
...
for pos in run_mcmc_iterator(emu, cat, param_names, y, cov, tpoints,obs_nd, obs_nd_err,'calc_analytic_nd', fixed_params = fixed_params,nwalkers = nwalkers, nsteps = nsteps, nburn = nburn, ncores=6):#,\
