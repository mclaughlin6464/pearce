...
y = np.loadtxt('xi_gg_true_jk_%d%d.npy'%(boxno, realization))
y = y[-emu.n_bins:]
...
chain_fname = path.join(savedir, '%d_walkers_%d_steps_xigg_hod_r%d_%d_rmin_emu2_jk.npy'%(nwalkers, nsteps, boxno, realization))
