...
fixed_params = {'mean_occupation_satellites_assembias_split1':0.5}
#{'f_c':1.0}#,'logM1': 13.8 }# 'z':0.0}
...
np.savetxt(path.join(savedir, '%d_walkers_%d_steps_chain_vpeak_sham_free_split_fixed_sat.npy'%(nwalkers, nsteps)), chain)
