...
cat.load(1.0, HOD='fscabRedMagic')
em_params = {}
em_params.update(cat.model.param_dict) # make sure all keys are in here as they're supposed to be .
...
em_params.update(dict(emulation_point))
