...
#0.85474
#0.8112
cat = cat_dict['chinchilla'](400.0, scale_factors = [0.81120], system = 'ki-ls')

cat.cache(overwrite = True, add_local_density=False, add_particles=True,downsample_factor = 1e-1)
