...
all_boxes = glob('~/scratch/hlists/hlist_1.00.list.trainingbox_??.hdf5')
all_boxes = glob('~/scratch/hlists/ptcl_1.00.list.trainingbox_most_recent_??.hdf5')

for boxno, t in enumerate(sorted(all_boxes)):
    print boxno
